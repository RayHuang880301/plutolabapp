    ...
    <div className={styles.section}>
      <div className={styles.container}>
        ...
        <div className={styles.windowBox}>
          ...
          <Window top={20} left={50} width={'26vw'} height={'13vw'}><Image src={aceLogo} alt=''/></Window>
          <Window top={50} left={5} width={'26vw'} height={14'13vw'8}><Image src={aceLogo} alt=''/></Window>
