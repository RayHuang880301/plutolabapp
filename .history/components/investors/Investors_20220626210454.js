    ...
    <div className={styles.section}>
      <div className={styles.container}>
        ...
        <div className={styles.windowBox}>
          {/* w : h = 400 :185 */}
          <Window top={0} left={0} width={320} height={148}><Image src={svLogo} alt=''/></Window>
          <Window top={60} left={20} width={320} height={148}><Image src={aceLogo} alt=''/></Window>
          <Window top={60} left={65} width={320} height={148}><Image src={aceLogo} alt=''/></Window>
          <Window top={50} left={65} width={320} height={148}><Image src={aceLogo} alt=''/></Window>
        </div>
