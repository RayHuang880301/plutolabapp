      ...
      <div className={styles.container}>
        ...
        <div className={styles.itemsMarquee}>
          <div className={styles.items} style={itemsStyle}>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} bg={plutoBg} link="https://plutohiphopdept.com/" width={250} height={250} alt=''/>
            <ImgCard src={gecko} defaultLogo={geckoDefaultLogo} bg={plutoBg} link="https://plutohiphopdept.com/" width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} bg={plutoBg} link="https://plutohiphopdept.com/" width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} bg={plutoBg} link="https://plutohiphopdept.com/" width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} bg={plutoBg} link="https://plutohiphopdept.com/" width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} bg={plutoBg} link="https://plutohiphopdept.com/" width={250} height={250} alt=''/>
