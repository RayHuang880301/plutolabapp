...
import parkparkBg from '../../assets/parkparkBg.png'
      ...
      <div className={styles.container}>
        ...
        <div className={styles.itemsMarquee}>
          <div className={styles.items}>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} bg={plutoBg} link="https://plutohiphopdept.com/" intro="Lil Pluto, the OG pass for the Pluto Metaverse, 3333 Unique Creatures living on Pluto." width={250} height={250} layout="responsive" alt=''/>
            ...
            <ImgCard src={parkpark} defaultLogo={parkparkDefaultLogo} bg={parkparkBg} link="https://opensea.io/assets/ethereum/0x0d2d8caaa06547c167f391b8c08f248a94b7b74d/2" intro="Pluto Lab x Park Park Carnival" width={250} height={250} alt=''/>
