      ...
      <div className={styles.container}>
        ...
        <div className={styles.itemsMarquee}>
          <div className={styles.items} style={itemsStyle}>
            ...
            <ImgCard src={studio} defaultLogo={plutoDefaultLogo} bg={studioBg} link="https://opensea.io/collection/pluto-studio-nft" intro="Lil Pluto is making music! Pluto Studio is the exclusive studio for every Lil Pluto." width={250} height={250} alt=''/>
            <ImgCard src={studio} defaultLogo={plutoDefaultLogo} bg={demiBg} link="https://opensea.io/assets/ethereum/0x0d2d8caaa06547c167f391b8c08f248a94b7b74d/1" intro="Pluto Lab x Demi-Human Studio" width={250} height={250} alt=''/>
            {/* TODO: demi */}
