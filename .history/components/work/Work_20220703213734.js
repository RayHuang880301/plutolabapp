...
import plutoDefaultLogo from '../../assets/defaultLogo.png'
      ...
      <div className={styles.container}>
        ...
        <div className={styles.itemsMarquee}>
          <div className={styles.items} style={itemsStyle}>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} width={250} height={240} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} width={250} height={250} alt=''/>
            <ImgCard src={pluto} defaultLogo={plutoDefaultLogo} width={250} height={250} alt=''/>
